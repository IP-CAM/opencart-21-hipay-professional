...
*/
class Controllerpaymenthipaycc extends Controller {
    ...
    public function index() {
        ...
        $data['continue'] = $this->url->link('payment/hipaycc/payment');
        $data['heading_title'] = $this->language->get('heading_title'); // set the heading_title of the module
                 
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/hipaycc.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/payment/hipaycc.tpl', $data);
        } else {
            return $this->load->view('default/template/payment/hipaycc.tpl', $data);
        }
    }
    ...
    public function payment(){
        ...
        $params->setURLOk($this->url->link('payment/hipaycc/success'));
        $params->setUrlNok($this->url->link('payment/hipaycc/error'));
        $params->setUrlCancel($this->url->link('payment/hipaycc/cancel'));
        $params->setEmailAck($this->config->get('hipaycc_email'));
        $params->setUrlAck($this->url->link('payment/hipaycc/ack'));
